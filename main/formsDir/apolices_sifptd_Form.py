...
class ApolicesSIFPTDForm(forms.ModelForm):
    class Meta:
        model = ApolicesSIFPTD
        fields = '__all__'
        widgets = {
            'movimento': forms.RadioSelect(choices=ApolicesSIFPTD.STATUS_CHOICES,attrs={'class': 'form-check-input'}),
            'movimentoconjuge': forms.RadioSelect(choices=ApolicesSIFPTD.STATUS_CHOICES, attrs={'class': 'form-check-input'}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["apolice"].queryset = ApolicesGerais.objects.filter(tipo='sifptd')